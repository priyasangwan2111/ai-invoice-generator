...
const SignUp = () => {
  ...
  const validateName=(name)=>{
    ...
    if(name.length>50) return "Name should not be more than 50 characters long";
    return ""
  }
  ...
  const handleSubmit=async()=>{
    ...
    if(nameError || emailError || passwordError || confirmPasswordError){
      setFieldErrors({name:nameError, email:emailError, password:passwordError, confirmPassword:confirmPasswordError
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User classNName="absolute left-4 top-1/2 transform-translate-y-1/2 text-gray-400 w-5 h-5"/>
                <input
                  name="name"
                  type="text"
                  required
        ...
        <div>
          ...
          <div className="relative">
            <Lock className="absolute left-4 top-1/2 transform-translaye-y-1/2 text-gray-400 w-5 h-5"/>
            <input 
        ...
        <div className="flex items-start pt-2">
          <input
            type="checkbox"
            id="terms"
            className="w-4 h-4 text-black border-gary-300 rouned focus:ring-vlack mt-1"
            required
          />
