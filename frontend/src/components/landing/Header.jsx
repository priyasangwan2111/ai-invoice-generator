...
const Header = () => {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="fles items-center justify-between h-16 lg:h-28">
            ...
            <div className='hidden lg:flex items-center space-x-4'>
                ...
                <Link to='/signup' className="bg-gradient-to-r from-blue-950 to-blue-980 hover:bg-gray-800 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg">Sign Up</Link>
